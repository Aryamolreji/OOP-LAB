...
class StringAndStringBuffer
 {
	...
	{
	StringBuffer s = new StringBuffer("Aryamol");
		int p = s.length();
		int q = s.capacity();
		System.out.println("Length of string Aryamol=" + p);
		System.out.println("Capacity of string Aryamol=" + q);
    s.append(" Reji");
    ...
    s.delete(0, 2);
            ...
            s.replace(0,5,"a");
            System.out.println("After replacing with 'a' from 0th to 5th ponmsition ="+s);
